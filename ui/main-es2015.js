...
let ChantierDetailComponent = class ChantierDetailComponent {
    ...
    rallongeChantier(chantier, dateFin, heureFin) {
...
let ChantierService = class ChantierService {
    ...
    rallongeChantier(chantier, dateFin) {
        return this.http.post(this.rallongeChantierUrl, { 'chantier': chantier, 'end': dateFin }, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('rallongeChantier')));
    }
